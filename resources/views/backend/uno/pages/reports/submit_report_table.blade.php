{{-- ════════════════════════════════════════════════════════════════
     submit_report_table.blade.php  (UNO)
     submitFilter keys: from_date, to_date, district (locked),
...
<div class="filter-section">
    ...
    <div style="position: relative;">
        <input
            type="text"
            x-model="submitStationSearch"
            @input="submitStationOpen = true"
            @focus="submitStationOpen = true"
            @keydown.escape="submitStationOpen = false"
                            ...
                            <div class="fuel-rows">
                                <div class="fuel-row">
                                    <span class="diff-status-badge"
                                        :class="{
                                            'diff-status-normal': row.status === 'Submitted',
                                            'diff-status-high':   row.status === 'Pending'
                                        }"
                                        x-text="row.status">
                                    </span>
                                </div>
