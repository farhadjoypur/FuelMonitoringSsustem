    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width:7%">Prev. Stock (L)</th>
                <th style="width:7%">Supply From Depot (L)</th>
                <th style="width:7%">Received At Station (L)</th>
                <th style="width:7%">Difference (L)</th>
                <th style="width:7%">Sales (L)</th>
                <th style="width:7%">Closing Stock (L)</th>
