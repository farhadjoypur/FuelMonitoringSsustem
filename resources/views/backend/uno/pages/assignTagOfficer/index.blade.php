...
@section('content')
    <div class="container-fluid p-4">
        ...
        {{-- <form action="{{ route('uno.assign-tag-officer.index') }}" method="GET">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn-action edit-btn border-0 bg-transparent me-2"
                                        ...
                                        data-url="{{ route('uno.assign-tag-officer.update', $assignment->id) }}">
                                        <i class="bi bi-pencil-square text-primary"></i>
                                    </button>

                                    {{-- <form action="{{ route('uno.assign-tag-officer.destroy', $assignment->id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 15px; border: none;">
                ...
                <div class="modal-body px-4">
                    <form action="{{ route('uno.assign-tag-officer.store') }}" method="POST">
                        @csrf
