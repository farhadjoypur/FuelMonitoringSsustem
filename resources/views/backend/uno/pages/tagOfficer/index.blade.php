...
@section('content')
    <div class="container-fluid p-4">
        ...
        <form action="{{ route('uno.tag-officer.index') }}" method="GET"
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <button class="btn-action btn-edit me-2 edit-btn" data-id="{{ $officer->id }}"
                                            ...
                                            data-url="{{ route('uno.tag-officer.update', $officer->id) }}" title="Edit">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>

                                        <form action="{{ route('uno.tag-officer.destroy', $officer->id) }}" method="POST"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 15px;">
                ...
                <div class="modal-body px-4">
                    <form action="{{ route('uno.tag-officer.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
