...
@section('content')
    <div class="container-fluid p-4">
        ...
        <form action="{{ route('uno.filling-station.index') }}" method="GET"
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <button class="btn-action btn-edit me-2 edit-btn" data-id="{{ $station->id }}"
                                            ...
                                            data-url="{{ route('uno.filling-station.update', $station->id) }}"
                                            title="Edit">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>

                                        <form action="{{ route('uno.filling-station.destroy', $station->id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content" style="border-radius: 12px; border: none;">
                ...
                <div class="modal-body p-4">
                    <form action="{{ route('uno.filling-station.store') }}" method="POST"
