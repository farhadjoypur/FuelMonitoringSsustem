                            ...
                            <tr data-division="{{ strtolower($station->division ?? '') }}"
                                ...
                                <td>
                                    <div class="actions-cell">
                                        {{-- View --}}
                                        <!-- <a href="{{ route('uno.stations.show', $station->id) }}" class="action-btn action-btn-view" title="View">
...
@push('scripts')
    ...
    <script>
        ...
        function submitEditForm() {
            ...
            fetch(`/uno/stations/${currentEditId}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                    },
