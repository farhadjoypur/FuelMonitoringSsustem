...
@push('styles')
    <style>
        ...
        .form-control-cm.is-invalid {
            border-color: #ef4444;
        }

        textarea.form-control-cm {
            resize: vertical;
            min-height: 90px;
        }
    ...
    <div class="cm-wrapper">
        ...
        <div class="cm-header">
            <div>
                ...
                <p>Fill in the details to register a new filling station</p>
            </div>
            ...
            <form action="{{ route('stations.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid form-grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="station_name"
                            ...
                            value="{{ old('station_name') }}" placeholder="e.g. Padma Filling Station">
                        @error('station_name')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="station_code"
                            ...
                            value="{{ old('station_code') }}" placeholder="e.g. PFS-001">
                        @error('station_code')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="linked_depot"
                            ...
                            value="{{ old('linked_depot') }}" placeholder="e.g. Chittagong Depot">
                        @error('linked_depot')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-grid form-grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="owner_phone"
                            ...
                            value="{{ old('owner_phone') }}" placeholder="+880 1X XXXX XXXX">
                        @error('owner_phone')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-grid form-grid-3">
                    <div class="form-group">
                        ...
                        <select name="division" class="form-control-cm @error('division') is-invalid @enderror">
                            ...
                            @foreach (['Dhaka', 'Chittagong', 'Rajshahi', 'Khulna', 'Barishal', 'Sylhet', 'Rangpur', 'Mymensingh'] as $div)
                                <option value="{{ $div }}" {{ old('division') == $div ? 'selected' : '' }}>
                                    {{ $div }}</option>
                            @endforeach
                        </select>
                        @error('division')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="district"
                            class="form-control-cm @error('district') is-invalid @enderror" value="{{ old('district') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="upazila" class="form-control-cm @error('upazila') is-invalid @enderror"
                            value="{{ old('upazila') }}" placeholder="e.g. Savar">
                        @error('upazila')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-grid form-grid-1" style="margin-bottom: 28px;">
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-control-cm @error('address') is-invalid @enderror"
                ...
                <div class="form-grid form-grid-2">
                    <div class="form-group">
                        ...
                        <input type="number" name="tank_capacity"
                            ...
                            value="{{ old('tank_capacity') }}" placeholder="e.g. 10000">
                        @error('tank_capacity')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="file-upload-label" for="license_file" id="fileLabel">
                            ...
                            <span id="fileLabelText">Click to upload license file (PDF/Image)</span>
                        </label>
                        ...
                        @foreach (['Petrol', 'Diesel', 'Octane'] as $fuel)
                            <label class="fuel-check {{ in_array($fuel, $oldFuels) ? 'checked' : '' }}"
                                ...
                                <input type="checkbox" name="fuel_types[]" value="{{ $fuel }}"
                                    {{ in_array($fuel, $oldFuels) ? 'checked' : '' }}>
                                {{ $fuel }}
                            </label>
                        @endforeach
                    </div>
...
@section('scripts')
    <script>
        ...
        document.getElementById('license_file').addEventListener('change', function() {
            const name = this.files[0] ? this.files[0].name : 'Click to upload license file (PDF/Image)';
