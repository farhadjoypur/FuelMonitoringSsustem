...
@section('content')
    <div class="container-fluid p-4">
        ...
        <form action="{{ route('dc.tag-officer.index') }}" method="GET" class="bg-white p-3 rounded shadow-sm border mb-4">
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody id="dcTableBody">
                        @forelse($tagOfficers as $key => $officer)
                            <tr>
                                <td>{{ $tagOfficers->firstItem() + $key }}</td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <button class="btn-action btn-edit me-2 edit-btn" data-id="{{ $officer->id }}"
                                            ...
                                            data-url="{{ route('dc.tag-officer.update', $officer->id) }}" title="Edit">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>

                                        <form action="{{ route('dc.tag-officer.destroy', $officer->id) }}" method="POST"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 15px;">
                ...
                <div class="modal-body px-4">
                    <form action="{{ route('dc.tag-officer.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
