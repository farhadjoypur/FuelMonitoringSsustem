                ...
                <div class="form-grid form-grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="station_code"
                            ...
                            value="{{ old('station_code', $station->station_code) }}" placeholder="e.g. PFS-001">
                        @error('station_code')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="linked_depot"
                            ...
                            value="{{ old('linked_depot', $station->linked_depot) }}" placeholder="e.g. Chittagong Depot">
                        @error('linked_depot')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-grid form-grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="owner_name"
                            ...
                            value="{{ old('owner_name', $station->owner_name) }}" placeholder="Full name">
                        @error('owner_name')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="owner_phone"
                            ...
                            value="{{ old('owner_phone', $station->owner_phone) }}" placeholder="+880 1X XXXX XXXX">
                        @error('owner_phone')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="district"
                            ...
                            value="{{ old('district', $station->district) }}" placeholder="e.g. Dhaka">
                        @error('district')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="upazila" class="form-control-cm @error('upazila') is-invalid @enderror"
                            value="{{ old('upazila', $station->upazila) }}" placeholder="e.g. Savar">
                        @error('upazila')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-grid form-grid-2">
                    <div class="form-group">
                        ...
                        <input type="number" name="tank_capacity"
                            ...
                            value="{{ old('tank_capacity', $station->tank_capacity) }}" placeholder="e.g. 10000">
                        @error('tank_capacity')
                            <span class="error-msg">{{ $message }}</span>
                        @enderror
                    </div>
