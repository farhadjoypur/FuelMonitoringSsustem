...
<div class="report-container">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('dc.reports.index') }}" class="btn-back">
    ...
    <form action="{{ route('dc.reports.update', $fuelReport) }}" method="POST" id="dcEditForm">
        ...
        <div style="display:flex; gap:14px; margin-bottom:40px; align-items:center;">
            ...
            <a href="{{ route('dc.reports.index') }}" class="btn-back">Cancel</a>
        </div>
...
(function() {
    ...
    function init() {
        ...
        const form = document.getElementById('dcEditForm');
        if (form) {
        ...
        console.log('DC Edit Form initialized - Warning messages enabled');
    }
})();
</script>
@endpush