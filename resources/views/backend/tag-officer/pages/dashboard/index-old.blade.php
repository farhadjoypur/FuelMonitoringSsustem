...
.fc-diesel { background: #fff7ed; border-color: #fed7aa; }
...
.fi-p { background: #22c55e; }
.fi-d { background: #f97316; }
.fi-o { background: #ef4444; }
...
.fc-petrol .fuel-val,
.fc-petrol .fuel-name { color: #16a34a; }

.fc-diesel .fuel-val,
.fc-diesel .fuel-name { color: #ea580c; }

.fc-octane .fuel-val,
.fc-octane .fuel-name { color: #ef4444; }
...
.ws-lbl { color: var(--muted); }
.ws-val { font-weight: 700; color: var(--text); }
...
.al-red    { background: #ef4444; }
.al-yellow { background: #f59e0b; }
.al-blue   { background: #2563eb; }
</style>
@endpush
    ...
    options: {
        ...
        scales: {
            x: {
                ...
                ticks: { font: { size: 11 }, color: '#7a8899' }
            },
            y: {
                grid: { color: 'rgba(0,0,0,.06)' },
                ticks: {
                    font: { size: 11 }, color: '#7a8899',
