...
@section('title', 'Edit Fuel Report')
...
<style>
    ...
    .report-header { text-align: center; padding: 20px; border-bottom: 1px solid #f1f5f9; }
    .report-header h5 { font-weight: 700; color: var(--dark); font-size: 16px; margin-bottom: 6px; }
    .report-header h5 i { color: var(--primary); margin-right: 8px; }
    .edit-badge { font-size: 11px; font-weight: 700; color: var(--primary); background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 20px; padding: 3px 12px; letter-spacing: .3px; }
    ...
    .btn-update { background: #16a34a; color: #fff; border: none; border-radius: 8px; padding: 12px 28px; font-size: 14px; font-weight: 600; }
    .btn-update:hover { background: #15803d; }
    .btn-update i { margin-right: 7px; }
    .btn-cancel { background: #f1f5f9; color: var(--dark); border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px 22px; font-size: 14px; font-weight: 600; text-decoration: none; }
...
<div class="report-container">
    ...
    <div class="page-header">
        <h4><i class="fa-solid fa-pen-to-square"></i> Edit Fuel Report</h4>
        <a href="{{ route('fuel-reports.index') }}" class="btn-cancel">
            <i class="fa-solid fa-arrow-left fa-xs"></i> Back
        </a>
    </div>

    <form action="{{ route('fuel-reports.update', $fuelReport) }}" method="POST">
        @csrf @method('PUT')
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="station_name"
                               ...
                               value="{{ old('station_name', $fuelReport->station_name) }}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="thana_upazila"
                               ...
                               value="{{ old('thana_upazila', $fuelReport->thana_upazila) }}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="district"
                               ...
                               value="{{ old('district', $fuelReport->district) }}" required>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="date" name="report_date"
                               ...
                               value="{{ old('report_date', $fuelReport->report_date->format('Y-m-d')) }}" required>
            ...
            <div class="input-grid">
                ...
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="petrol_prev_stock" id="petrol_prev_stock"
                           class="input-field @error('petrol_prev_stock') is-invalid @enderror"
                           value="{{ old('petrol_prev_stock', $fuelReport->petrol_prev_stock) }}"
                ...
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="petrol_supply" id="petrol_supply"
                           class="input-field" value="{{ old('petrol_supply', $fuelReport->petrol_supply) }}"
                           oninput="calcRow('petrol')">
                </div>
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="petrol_received" id="petrol_received"
                           class="input-field" value="{{ old('petrol_received', $fuelReport->petrol_received) }}"
                           oninput="calcRow('petrol')">
                </div>
                <div class="grid-cell-auto">
                    <span class="auto-value" id="petrol_difference_display">{{ $fuelReport->petrol_difference }}</span>
                    <span class="auto-label">Auto</span>
                </div>
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="petrol_sales" id="petrol_sales"
                           class="input-field" value="{{ old('petrol_sales', $fuelReport->petrol_sales) }}"
                           oninput="calcRow('petrol')">
                </div>
                <div class="grid-cell-auto">
                    <span class="auto-value" id="petrol_closing_display">{{ $fuelReport->petrol_closing_stock }}</span>
                    <span class="auto-label">Auto</span>
                </div>
            </div>
        </div>
            ...
            <div class="input-grid">
                ...
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="diesel_prev_stock" id="diesel_prev_stock"
                           class="input-field @error('diesel_prev_stock') is-invalid @enderror"
                           value="{{ old('diesel_prev_stock', $fuelReport->diesel_prev_stock) }}"
                ...
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="diesel_supply" id="diesel_supply"
                           class="input-field" value="{{ old('diesel_supply', $fuelReport->diesel_supply) }}"
                           oninput="calcRow('diesel')">
                </div>
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="diesel_received" id="diesel_received"
                           class="input-field" value="{{ old('diesel_received', $fuelReport->diesel_received) }}"
                           oninput="calcRow('diesel')">
                </div>
                <div class="grid-cell-auto">
                    <span class="auto-value" id="diesel_difference_display">{{ $fuelReport->diesel_difference }}</span>
                    <span class="auto-label">Auto</span>
                </div>
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="diesel_sales" id="diesel_sales"
                           class="input-field" value="{{ old('diesel_sales', $fuelReport->diesel_sales) }}"
                           oninput="calcRow('diesel')">
                </div>
                <div class="grid-cell-auto">
                    <span class="auto-value" id="diesel_closing_display">{{ $fuelReport->diesel_closing_stock }}</span>
                    <span class="auto-label">Auto</span>
                </div>
            </div>
        </div>
            ...
            <div class="input-grid">
                ...
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="octane_prev_stock" id="octane_prev_stock"
                           class="input-field @error('octane_prev_stock') is-invalid @enderror"
                           value="{{ old('octane_prev_stock', $fuelReport->octane_prev_stock) }}"
                ...
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="octane_supply" id="octane_supply"
                           class="input-field" value="{{ old('octane_supply', $fuelReport->octane_supply) }}"
                           oninput="calcRow('octane')">
                </div>
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="octane_received" id="octane_received"
                           class="input-field" value="{{ old('octane_received', $fuelReport->octane_received) }}"
                           oninput="calcRow('octane')">
                </div>
                <div class="grid-cell-auto">
                    <span class="auto-value" id="octane_difference_display">{{ $fuelReport->octane_difference }}</span>
                    <span class="auto-label">Auto</span>
                </div>
                <div class="grid-cell">
                    <input type="number" step="0.01" min="0" name="octane_sales" id="octane_sales"
                           class="input-field" value="{{ old('octane_sales', $fuelReport->octane_sales) }}"
                           oninput="calcRow('octane')">
                </div>
                <div class="grid-cell-auto">
                    <span class="auto-value" id="octane_closing_display">{{ $fuelReport->octane_closing_stock }}</span>
                    <span class="auto-label">Auto</span>
                </div>
            </div>
        </div>
