...
@section('content')
    <div class="fs-wrapper">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form action="{{ route('admin.depots.index') }}" method="GET" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="q" id="searchInput" class="form-control"
                                    placeholder="Name, code or district..." value="{{ request('q') }}">
                            </div>
                        </div>

                        <div class="col-md-5">
                            <label class="form-label small fw-bold text-muted">Filter by District</label>
                        ...
                        <div class="col-md-2">
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.depots.index') }}" class="btn btn-light border w-100 text-nowrap">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0" id="depotTable">
                    ...
                    <tbody id="tableBody">
                        @forelse($depots as $depot)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <form action="{{ route('admin.depots.destroy', $depot->id) }}" method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-5 text-muted">No depots found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                    ...
                    <form id="createDepotForm">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="depot_name" class="form-control form-control-lg"
                                    placeholder="Enter depot name" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Depot Code <span class="text-danger">*</span></label>
                                <input type="text" name="depot_code" class="form-control form-control-lg"
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Capacity (Litres) <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="number" step="0.01" name="capacity"
                                        class="form-control form-control-lg" placeholder="50000" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="number_of_tanks" class="form-control form-control-lg"
                                    placeholder="e.g. 8">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch mt-3">
                                    <input class="form-check-input" type="checkbox" name="status" id="createStatus"
                                        value="active" checked style="width: 3rem; height: 1.6rem;">
...
@push('scripts')
    <script>
        ...
        function openEditModal(id) {
            ...
            body.innerHTML =
                `<div class="text-center py-5"><div class="spinner-border text-primary"></div><p>Loading depot data...</p></div>`;
