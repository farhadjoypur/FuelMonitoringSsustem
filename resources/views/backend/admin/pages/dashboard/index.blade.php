...
<style>
    ...
    .fuel-main-card.others { background: #c8eff0; }
    ...
    .fuel-icon-circle.ot { background: var(--others-color); }
    ...
    .fuel-main-card.others .fmi-val,
    .fuel-main-card.others .fmi-name { color: var(--others-color); }
    ...
    .diff-pill.others { background: #E0F9FA; color: var(--others-color); border: 1px solid #99E5E8; }
