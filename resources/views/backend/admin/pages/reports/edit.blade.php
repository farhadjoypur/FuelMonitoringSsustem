...
<div class="report-container">
    ...
    <div class="admin-banner">
        ...
        Admin Mode — You can edit any report regardless of date. No date restrictions apply.
    </div>
    ...
    <form action="{{ route('admin.reports.update', $fuelReport) }}" method="POST" id="adminEditForm">
        @csrf
        @method('PUT')
        ...
        <div style="display:flex; gap:14px; margin-bottom:40px; align-items:center;">
            ...
            <a href="{{ route('admin.reports.index') }}" class="btn-back">Cancel</a>
        </div>
