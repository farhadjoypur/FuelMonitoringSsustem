    ...
    <div class="filter-grid">
        ...
        <div class="form-group">
            ...
            <input type="number" min="0" placeholder="e.g. 100"
                x-model="diffFilter.minDifferenceL">
        </div>
...
<div class="table-section">
    ...
    <div x-show="diffTotalPages > 1"
        ...
        <span x-text="`Page ${diffCurrentPage} of ${diffTotalPages} — ${diffTotalRecords} records`"></span>
        <div style="display:flex; gap:6px;">
            <button class="btn-page"
                :disabled="diffCurrentPage <= 1"
                @click="changeDiffPage(diffCurrentPage - 1)">
...
<style>
    ...
    .btn-diff-export-pdf:hover { background: #dc2626; }

    /* Difference value colours */
    .diff-value-nonzero     { color: #dc2626; font-weight: 700; }
    .diff-percent-negative  { color: #dc2626; font-weight: 700; }
    .diff-percent-positive  { color: #f59e0b; font-weight: 700; }
    ...
    .diff-status-high   { background: #fef2f2; color: #991b1b; }
    .diff-status-low    { background: #fff7ed; color: #c2410c; }
    .diff-status-normal { background: #f0fdf4; color: #15803d; }
