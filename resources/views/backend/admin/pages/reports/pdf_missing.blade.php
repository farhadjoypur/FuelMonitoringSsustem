...
<body>
    ...
    <div class="report-title">Tag Officer Missing Reports</div>
    ...
    <table>
        <thead>
            <tr>
                <th style="width:3%">#</th>
                <th style="width:9%">Missing Date</th>
                <th style="width:13%">Officer Name</th>
                <th style="width:10%">Phone</th>
                <th style="width:9%">Division</th>
                <th style="width:9%">District</th>
                <th style="width:9%">Upazila</th>
                <th style="width:17%">Filling Station</th>
                <th style="width:8%">Company</th>
                <th style="width:8%">Depot</th>
